...
var file_lightnode_lightnode_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x79, 0x32, 0x81, 0x01, 0x0a, 0x06, 0x53, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x40,
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x32, 0x4d, 0x0a, 0x08, 0x52, 0x65, 0x63, 0x65, 0x69,
	0x76, 0x65, 0x72, 0x12, 0x41, 0x0a, 0x0b, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x44, 0x61,
	0x74, 0x61, 0x12, 0x18, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76,
	0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x6e,
	0x6f, 0x64, 0x65, 0x2e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52,
	...
	0x6c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x6f, 0x64, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_lightnode_lightnode_proto_depIdxs = []int32{
	0, // 0: node.Sender.StreamData:input_type -> node.StreamDataRequest
	2, // 1: node.Sender.GetData:input_type -> node.GetDataRequest
	4, // 2: node.Receiver.ReceiveData:input_type -> node.ReceiveDataRequest
	1, // 3: node.Sender.StreamData:output_type -> node.StreamDataReply
	3, // 4: node.Sender.GetData:output_type -> node.GetDataReply
	5, // 5: node.Receiver.ReceiveData:output_type -> node.ReceiveDataReply
